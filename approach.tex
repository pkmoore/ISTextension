...
Replay makes tests repeatable by ensuring
applications will always execute
code paths and present opportunities to simulate anomalies.  In a similar
fashion, it eases the process of manipulating system calls by guaranteeing
an application's state is always the same at a given point in time.
