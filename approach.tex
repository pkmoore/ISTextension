...
$Y_1$ and $Y_2$ may be generated and
used to test two scenarios where a fail access may fail:
\begin{enumerate}
...
Keeping $Y$ intact (as opposed to destroying
it by introducing an error state) avoids the penalty
of having to restart a new execution for each
test.
