...
description of its anomaly to carry out its simulation.  Checkers operate
similarly,
...
To simulate anomalies we developed
...
We extended this capability, by liberating process sets from {\tt
...
During the course of this simulation, a mutator
simulates the anomaly being tested and the corresponding checker
monitors the application's response.
Supervisors can complete this
process independently of one another, which lends a
high degree of speed and
parallelism to the whole CrashSimulator testing process.  The results of
