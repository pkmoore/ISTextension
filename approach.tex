...
We explore this, and other checkers in our evaluation~\ref{SEC:evaluation}.
...
language that can execute Linux system calls -- a key feature given
we want to test many applications without per application effort.
Working with system calls is a good fit
