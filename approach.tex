...
where we could influence an application’s communications. Functioning on
...
Another challenge in implementing SEA was it required a method to simulate anomalies. During testing and early applications we introduced a new technique called {\it process set cloning}.  As noted above, 
...
However, we extended this capability
