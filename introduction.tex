...
Guiding our efforts
is a technique
we call \textit{Simulation of Anomalous Environments} (SEA).
...
using simulation -- further illustrating the time savings offered by SEA.
...
\item{It introduces \textit{Simulation of Anomalous Environments}
