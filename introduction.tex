...
in such a way
that its responses will indicate any potential
...
these anomalies,
giving them a formal and reproducible strategy for future application
tests.
...
The effort required to actually test applications against the
these conditions far exceeded the time required to evaluate them
using simulation -- further illustrating the time savings offered by AES.
