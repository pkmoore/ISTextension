...
\noindent {\bf Static analysis. } Tools based on static analysis
techniques, such as abstract interpretation, model checking, and symbolic
execution have been used to successfully detect bugs related to incorrect
API usage. Examples include SLAM~\cite{Ball_adecade,
Ball:2002:SLP:503272.503274} and, more recently,
