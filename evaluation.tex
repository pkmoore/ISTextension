...
\hline
        {\tt Aspell}      & Dictionary File            & --        & \xmark: \textit{FP}      & \tickmark: \textit{FP}  & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt Aspell}      & File being checked         & --        & \xmark: \textit{FP}     & \tickmark: \textit{FP}  & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt gnu-gpg}     & secring.gpg                & --        & \xmark: \textit{FP}     & \xmark: \textit{FP}     & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt vim}         & File being opened          & --        & \tickmark: \textit{FP}  & \tickmark: \textit{FP}  & \tickmark: \textit{FP} & \tickmark: \textit{FP}     & \tickmark: \textit{FP}    & \xmark: \textit{FP}\\
        {\tt nano}        & File being opened          & --        & \tickmark: \textit{FP}  & \tickmark: \textit{FP}  & \tickmark: \textit{FP} & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt sed}         & File being edited          & --        & \xmark: \textit{FP}     & \tickmark: \textit{FP}  & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt df}          & /proc                      & \xmark: \textit{FP}    & --         & \xmark: \textit{FP}     & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt wc}          & File being checked         & --        & \tickmark: \textit{FP}  & \tickmark: \textit{FP}  & \tickmark: \textit{FP} & \tickmark: \textit{FP}     & \tickmark: \textit{FP}    & \tickmark: \textit{FP}\\
        {\tt du}          & Directory being checked    & \tickmark: \textit{FP} & --         & \tickmark: \textit{FP}  & \tickmark: \textit{FP} & \tickmark: \textit{FP}     & \tickmark: \textit{FP}    & \tickmark: \textit{FP}\\
        {\tt install}     & File being installed       & --        & \tickmark: \textit{FP}  & \xmark: \textit{FP}     & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \tickmark: \textit{FP}    & \xmark: \textit{FP}\\
        {\tt fmt}         & File being formatted       & --        & \xmark: \textit{FP}     & \tickmark: \textit{FP}  & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt od}          & File being dumped          & --        & \tickmark: \textit{FP}  & \tickmark: \textit{FP}  & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt ptx}         & File being read            & --        & \tickmark: \textit{FP}  & \tickmark: \textit{FP}  & \tickmark: \textit{FP} & \tickmark: \textit{FP}     & \tickmark: \textit{FP}    & \tickmark: \textit{FP}\\
        {\tt comm}        & Second file being compared & --        & \tickmark: \textit{FP}  & \tickmark: \textit{FP}  & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt pr}          & File being read            & --        & \tickmark: \textit{FP}  & \xmark: \textit{FP}     & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
\hline
