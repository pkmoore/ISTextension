...
and made errors in only YY cases.  We discuss the causes of these failures
...
\hline
        {\tt Aspell}      & Dictionary File            & \APLminus        & \xmark: \textit{FP}      & \tickmark: \textit{FP}  & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt Aspell}      & File being checked         & \APLminus        & \xmark: \textit{FP}     & \tickmark: \textit{FP}  & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt gnu-gpg}     & secring.gpg                & \APLminus        & \xmark: \textit{FP}     & \xmark: \textit{FP}     & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt vim}         & File being opened          & \APLminus        & \tickmark: \textit{FP}  & \tickmark: \textit{FP}  & \tickmark: \textit{FP} & \tickmark: \textit{FP}     & \tickmark: \textit{FP}    & \xmark: \textit{FP}\\
        {\tt nano}        & File being opened          & \APLminus        & \tickmark: \textit{FP}  & \tickmark: \textit{FP}  & \tickmark: \textit{FP} & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt sed}         & File being edited          & \APLminus        & \xmark: \textit{FP}     & \tickmark: \textit{FP}  & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt df}          & /proc                      & \xmark: \textit{FP}    & \APLminus         & \xmark: \textit{FP}     & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt wc}          & File being checked         & \APLminus        & \tickmark: \textit{FP}  & \tickmark: \textit{FP}  & \tickmark: \textit{FP} & \tickmark: \textit{FP}     & \tickmark: \textit{FP}    & \tickmark: \textit{FP}\\
        {\tt du}          & Directory being checked    & \tickmark: \textit{FP} & \APLminus         & \tickmark: \textit{FP}  & \tickmark: \textit{FP} & \tickmark: \textit{FP}     & \tickmark: \textit{FP}    & \tickmark: \textit{FP}\\
        {\tt install}     & File being installed       & \APLminus        & \tickmark: \textit{FP}  & \xmark: \textit{FP}     & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \tickmark: \textit{FP}    & \xmark: \textit{FP}\\
        {\tt fmt}         & File being formatted       & \APLminus        & \xmark: \textit{FP}     & \tickmark: \textit{FP}  & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt od}          & File being dumped          & \APLminus        & \tickmark: \textit{FP}  & \tickmark: \textit{FP}  & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt ptx}         & File being read            & \APLminus        & \tickmark: \textit{FP}  & \tickmark: \textit{FP}  & \tickmark: \textit{FP} & \tickmark: \textit{FP}     & \tickmark: \textit{FP}    & \tickmark: \textit{FP}\\
        {\tt comm}        & Second file being compared & \APLminus        & \tickmark: \textit{FP}  & \tickmark: \textit{FP}  & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
        {\tt pr}          & File being read            & \APLminus        & \tickmark: \textit{FP}  & \xmark: \textit{FP}     & \xmark: \textit{FP}    & \xmark: \textit{FP}        & \xmark: \textit{FP}       & \xmark: \textit{FP}\\
\hline
        ...
        \multicolumn{9}{l}{\scriptsize{\APLminus $=$ File type expected by the
        application}}\\
    \bottomrule{}
    \end{tabular}
