...
\hline
        {\tt Aspell}      & Dictionary File            & --                     & \textit{FP}             & \textit{FN}             & \xmark                 & \xmark                     & \xmark                    & \xmark    *\\
        {\tt Aspell}      & File being checked         & --                     & \textit{FP}             & \tickmark               & \xmark                 & \xmark                     & \xmark                    & \xmark    *\\
        {\tt gnu-gpg}     & secring.gpg                & --                     & \xmark                  & \xmark                  & \xmark                 & \xmark                     & \xmark                    & \xmark    *\\
        {\tt vim}         & File being opened          & --                     & \textit{FN}             & \textit{FN}             & \textit{FN}            & \textit{FN}                & \textit{FN}               & \xmark    *\\
        {\tt nano}        & File being opened          & --                     & \tickmark               & \tickmark               & \tickmark              & \textit{FP}                & \textit{FP}               & \xmark    *\\
        {\tt sed}         & File being edited          & --                     & \tickmark               & \textit{FN}             & \xmark                 & \xmark                     & \xmark                    & \xmark    *\\
