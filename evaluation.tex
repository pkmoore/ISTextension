...
to test each of the applications listed in Table{table:crossdevice}
...
and {\tt utime()} families which are used to retrieve and apply timestamps.
...
CrashSimulator to inject anomalies into an application.
...
such as a Linux application retrieving
and processing data from a file.
Linux supports
