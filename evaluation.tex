...
selected three test scenarios: a simple filesystem anomaly that relies on the null
mutator;
...
{\tt make}, archival programs, and similar
...
\hline
        ...
        {\tt rust}             & Correct             & {\bf Security Flaw} & {\bf Time Loss} & {\bf Fill Disk} \\
        {\tt boost::copyfile} & {\bf Corrupt}	      & {\bf Security Flaw} & {\bf Time Loss} & {\bf Fill Disk} \\
    \bottomrule{}
    \end{tabular}
...
\hline
    \bottomrule{}
    \end{tabular}}
    \caption{Res65nses of a sample of coreutils applications when exposed to
...
\begin{table}[t]
  ...
  \begin{tabular}{l | l}
    ...
    \bottomrule{}
  \end{tabular}
  \caption{Applications and libraries tested for their handling of extremely slow response
