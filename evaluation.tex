...
\subsubsection{Failed calls to close()}
...
retried.\preston{cite}  In some POSIX-like operating systems, such has
...
threads\preston{cite http://austingroupbugs.net/view.php?id=529}.
...
{\bf Findings.} As can be seen from table~\ref{table:failedclose},
...
\preston{In writing this, I think this information might better fit in the
implementation details section rather than an evaluation question.}
