\section{Evaluation Phase 1 -- Tool Efficacy and Efficiency}
...
\item{Can CrashSimulator execute tests efficiently? (Subsection~\ref{sec-perf})}
...
\subsubsection{Effects of user's background}
